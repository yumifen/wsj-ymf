    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"  id="vue_index" style="text-align: center;">
                        <span>
                            <img alt="image" class="img-circle" style="max-width: 50px"  v-bind:src ="photoUrl"/>
                        </span>
                ...
                <li>
                    <a  class="J_menuItem" href="${req.contextPath}/web/head">
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown hidden-xs">
                        <a href="${req.contextPath}/logout" class="right-sidebar-toggle" aria-expanded="false"> <i class="fa fa fa-sign-out"></i> 退出</a>
                    </li>
                </ul>
            </nav>
        </div>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="web-head"></a>
                </div>
            </nav>
            ...
            <a href="${req.contextPath}/logout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
