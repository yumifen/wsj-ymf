...
public class ShiroProperties {
    ...
    public void setFilterChainDefinitions(Map<String, String> filterChainDefinitions) {
        Map<String, String> filterChainDefinitions2 = new LinkedHashMap<>();
        for(Map.Entry<String, String> entry : filterChainDefinitions.entrySet()){
            filterChainDefinitions2.put("/"+entry.getKey().replace("-","/").replace("x","*"),entry.getValue());
        }
        this.filterChainDefinitions = filterChainDefinitions2;
    }
